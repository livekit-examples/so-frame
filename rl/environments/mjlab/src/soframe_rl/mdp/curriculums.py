...
lowers it when success drops. Starting at spread 0 with success 0, it holds the easy
layout until the policy learns to place, then widens randomization at whatever pace
the policy can keep up with (ADR-style automatic curriculum).
"""
