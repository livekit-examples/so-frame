...
They live here rather than in ``rl/maniskill/config.py`` because deploy needs them too and
...
the wire's units (degrees, and 0..100 for the rail) is deploy's job -- see sim2real/utils/bridge.py.
"""

from __future__ import annotations

# Joint order. Matches the URDF's active joints, the sim's action vector, and the wire contract
# in sim2real/portal.yaml. The rail comes first.
JOINT_NAMES = (
    "dof_slider",
    "shoulder_pan",
    "shoulder_lift",
